...
export const NodeIcon = ({ className, ...rest }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 128 128"
    ...
    >
      <path
        ...
        fill="url(#svg-nR8XDpybr7-a)"
      ></path>
      <path
        d="M116.897 29.76 66.841.825A8 8 0 0 0 65.302.23L9.21 96.798a6.3 6.3 0 0 0 1.657 1.43l50.057 28.934c1.42.833 3.076 1.072 4.615.595l52.66-96.925a3.7 3.7 0 0 0-1.302-1.072"
        fill="url(#svg-cCEE5Z7K4y-b)"
      ></path>
      <path
